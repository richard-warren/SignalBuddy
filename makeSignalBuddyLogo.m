...
% make figure
close all
hgtWidRatio = (faceHgt+hairHgt)*1.02 / xWidth;
figure('color', 'white', 'position', [200 200 1000 1000*hgtWidRatio], 'menubar', 'none'); hold on
...
% hair
rectangle('position', [-hairWid/2 0 hairWid faceHgt/2+hairHgt], ...
    'LineWidth', lineWidth(1), 'Curvature', .1, 'faceColor', hairColor, 'EdgeColor', lineColor);
rectangle('position', [-hairWid/2-faceWid/4 0 hairWid faceHgt/2+hairHgt], ...
    'LineWidth', lineWidth(1), 'Curvature', .1, 'faceColor', hairColor, 'EdgeColor', lineColor);
rectangle('position', [-hairWid/2+faceWid/4 0 hairWid faceHgt/2+hairHgt], ...
    'LineWidth', lineWidth(1), 'Curvature', .1, 'faceColor', hairColor, 'EdgeColor', lineColor);
% face
